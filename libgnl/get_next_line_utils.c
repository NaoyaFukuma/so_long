...
/*   Updated: 2022/08/25 10:50:24 by nfukuma          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_delete_one_strage(t_fd_info **static_p, t_fd_info **lst_p)
{
...
char	*ft_push_end_line(t_fd_info **lst_p)
{
	char	*newline;
	size_t	i;
...
char	*ft_parse_readsize(ssize_t readsize, char **buf, t_fd_info **lst_p,
		t_fd_info **static_p)
{
	free(*buf);
	*buf = NULL;
...
char	*ft_read_file_push_line(t_fd_info **lst_p, t_fd_info **static_p)
{
	char	*buf;
	char	*catstr;
	ssize_t	readsize;
